...
router = APIRouter(tags=["plaid"], responses={404: {"description": "Not found"}})
...
configuration = Configuration(
    host=f"https://{PLAID_ENV}.plaid.com",  # 전체 URL로 수정
    api_key={
...
class PublicTokenRequest(BaseModel):
    ...
    class Config:
        schema_extra = {"example": {"public_token": "public-sandbox-0000000000"}}
